...
import { FilterValuesType, todolistsThunks } from "features/TodolistsList/todolists.reducer";
import {
  AddTaskArgType,
  RemoveTaskArgType,
  TaskType,
...
const slice = createSlice({
  ...
  selectors: {
    selectTasksByTodolist: (state, todolistId) => state[todolistId],
    selectFilteredTasks: (state, filter: FilterValuesType, todolistId: string) => {
